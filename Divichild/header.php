...
?>
	<script>
		localStorage.setItem('user_name', "<?php echo $user_name; ?>");
	</script>
<?php
...
<body <?php body_class(); ?>>
	...
	<div id="page-container" <?php echo et_core_intentionally_unescaped($page_container_style, 'fixed_string'); ?>>
				...
				<div id="et-top-navigation" data-height="<?php echo esc_attr(et_get_option('menu_height', '66')); ?>" data-fixed-height="<?php echo esc_attr(et_get_option('minimized_menu_height', '40')); ?>">
					<?php if (!$et_slide_header || is_customize_preview()) : ?>
						<div class="pl_header_menu_dgn">
							...
							<?php endif; ?>
							<div class="pl_extra_header_menu_item">
								<div class="pl_login_icon"><i class="fas fa-user"></i> <span>Accedi</span></div>
								<?php echo do_shortcode('[pl_login_form]') ?>
							</div>
						</div>
					<?php endif; ?>
		...
		<div id="et-main-area">
			...
			<!-- Modal -->
			<div class="modal fade pl_pass_update_popup" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="staticBackdropLabel">Recupero della password</h5>
							<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
						</div>
						<div class="modal-body">
							<div class="pl_forgot_pass_recovery">
								<div id="pl_user_pass_recovery_form_message"></div>
								<form id="pl_user_pass_recovery_form" action="">
									<label for="">Email</label>
									<input name="user_email" type="email" placeholder="Digita la tua email">
									<hr>
